...
@Component({
  selector: 'awkaa-filter-combo',
  templateUrl: './awkaa-filter-combo.component.html',
  styleUrls: ['./awkaa-filter-combo.component.css'],
  host: {
   '(window:resize)': 'onResize($event)'
  }
})
export class AwkaaFilterComboComponent implements OnInit {
