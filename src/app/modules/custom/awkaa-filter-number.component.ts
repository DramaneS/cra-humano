...
@Component({
  selector: 'awkaa-filter-number',
  templateUrl: './awkaa-filter-number.component.html',
  styleUrls: ['./awkaa-filter-number.component.css'],
  host: {
   '(window:resize)': 'onResize($event)'
  }
})
export class AwkaaFilterNumberComponent implements OnInit {
